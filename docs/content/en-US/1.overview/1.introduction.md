...
- [LayoutNav](/en-US/components/layout-nav): header navigation component.
- [ThemeToggle](/en-US/components/theme-toggle): theme mode toggle button.
- [ThemeSettings](/en-US/components/theme-settings): full theme panel.
